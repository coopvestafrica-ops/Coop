...
class _LoanApplicationScreenState extends State<LoanApplicationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final baseInterestRate = loanInfo['interest'] as double;
  ...
  Widget _buildReferralBonusSection(BuildContext context, WidgetRef ref, Map<String, dynamic> loanInfo) {
    ...
    if (currentBonus <= 0) {
      ...
      return AppCard(
        backgroundColor: CoopvestColors.info.withOpacity(0.05),
        border: Border.all(color: CoopvestColors.info.withOpacity(0.2)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
