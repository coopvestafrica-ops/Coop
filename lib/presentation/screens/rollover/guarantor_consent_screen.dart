...
class GuarantorConsentScreen extends ConsumerWidget {
  ...
  Widget _buildConsentProgress(List<RolloverGuarantor> guarantors) {
    ...
    final progress = total > 0 ? accepted / total : 0;
    ...
    return CustomCard(
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
                  color: accepted == total ? AppColors.success : AppColors.primary,
                ),
              ),
            ],
          ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                declined > 0 ? AppColors.error : AppColors.success,
              ),
            ),
          ),
          ...
          Row(
            children: [
              _buildStatusIndicator(AppColors.success, 'Accepted: $accepted'),
              const SizedBox(width: 16),
              _buildStatusIndicator(AppColors.error, 'Declined: $declined'),
              const SizedBox(width: 16),
      ...
      return CustomCard(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            PrimaryButton(
              text: 'Replace Declined Guarantors',
              onPressed: () {
          ...
          children: [
            ...
            if (guarantor.status == GuarantorConsentStatus.declined &&
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.info, color: AppColors.error, size: 16),
